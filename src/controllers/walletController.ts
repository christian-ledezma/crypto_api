...
export const WalletController = {
  ...
  // GET /api/wallets/crypto/:cryptoId/balance
  getBalanceByCrypto: async (req: Request, res: Response): Promise<void> => {
    try {
      const userId = parseInt(req.params.userId);
      ...
      const balance = await walletService.getBalanceByCrypto(userId, cryptoId);
  ...
  updateWalletBalance: async (req: Request, res: Response): Promise<void> => {
    try {
